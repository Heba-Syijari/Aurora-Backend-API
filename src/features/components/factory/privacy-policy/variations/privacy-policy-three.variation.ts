...
import { PrivacyPolicyThreeContent } from 'src/features/content-generator/types';
...
export class PrivacyPoliceThreeVariation implements IComponentVariationFactory {
  constructor(
  ...
  private async getContent(
    ...
    try {
      ...
      throw new Error(
        'Failed to generate content for PrivacyPolicyThreeContent.',
      );
    }
  }
}
