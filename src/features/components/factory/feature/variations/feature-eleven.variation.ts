...
import { FeatureElevenContent } from 'src/features/content-generator/types';
...
export class FeatureElevenVariation implements IComponentVariationFactory {
  constructor(
  ...
  private async getContent(input: CreateInput): Promise<FeatureElevenContent> {
    try {
      ...
      throw new Error('Failed to generate content for FeatureElevenContent.');
    }
  }
}
