...
import { FeatureSixContent } from 'src/features/content-generator/types';
...
export class FeatureSixVariation implements IComponentVariationFactory {
  constructor(
  ...
  private async getContent(input: CreateInput): Promise<FeatureSixContent> {
    try {
      ...
      throw new Error('Failed to generate content for FeatureSixContent.');
    }
  }
}
